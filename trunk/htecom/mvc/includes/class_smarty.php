...
if (!defined('SMARTY_DIR')) {
    define('SMARTY_DIR', dirname(__FILE__) . DIRECTORY_SEPARATOR.'smarty/');
}
...
class Smarty
{
     ...
     * @var string
     */
    var $compiler_file        =    'smarty/Smarty_Compiler.class.php';
 ...
 */
    ...
    {
		$this->index_templ = $resource_name;
